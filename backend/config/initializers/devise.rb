...
Devise.setup do |config|
  ...
  # The number of stretches used for generating the hash. Stretches are logarithmic, meaning
  # that a value of 10 will be 10 times slower than a value of 9.
  #
  ...
  # ==> Turbo configuration
  # If your app is using Turbo, Turbo::Controller will be included by default, so forms work correctly.
  # However, if you are using Turbo with legacy Stimulus code, you can disable it to prevent conflicts.
  #
  # config.turbo = false
end
